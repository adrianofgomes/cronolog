...
This project is AI-driven. Always refer to `GEMINI.md` in the root for the full project architecture and mandates.

## 🤖 Core AI Mandates (Summary)
1. **Always Update Documentation:** Any changes to routes, features, or architecture must be reflected in `README.md`, `GEMINI.md`, and relevant docs.
